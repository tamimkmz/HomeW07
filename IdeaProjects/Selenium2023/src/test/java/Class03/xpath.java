...
//        find the text box and send some keys
        ...
        WebElement Field01 = driver.findElement(By.xpath("//input[@name='customField1' and @data-detail]"));
        Field01.sendKeys("donkey");

        WebElement Field02 = driver.findElement(By.xpath("//input[@name='customField1' and @data-detail='two']"));
        Field02.sendKeys("monkey");
